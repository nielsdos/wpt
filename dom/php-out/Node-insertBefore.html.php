...
test(function() {global $document;
  ...
  assert_throws_dom("NotFoundError", function() use ($a,$b,$c) {global $document;;
    $a->insertBefore($b, $c);
  });
...
test(function() {global $document;
  ...
  $doc2 = DOM\HTMLDocument::createEmpty();
  assert_throws_dom("HierarchyRequestError", function() use($doc,$doc2) {global $document;;
    $doc->insertBefore($doc2, $doc->documentElement);
  });
;
  assert_throws_dom("HierarchyRequestError", function() use($doc) {global $document;;
...
;
  ...
  assert_throws_dom("HierarchyRequestError", function() use ($doc,$df) {global $document;;
...
;
  ...
  assert_throws_dom("HierarchyRequestError", function() use ($doc,$df,$comment) {global $document;;
...
;
  $df = $doc->createDocumentFragment();
  $df->appendChild($doc->createElement("a"));
  assert_throws_dom("HierarchyRequestError", function() use ($df,$doc) {global $document;;
    $doc->insertBefore($df, $doc->doctype);
  });
...
;
  $df = $doc->createDocumentFragment();
  $df->appendChild($doc->createElement("a"));
  assert_throws_dom("HierarchyRequestError", function() use ($df,$doc,$comment) {global $document;;
    $doc->insertBefore($df, $comment);
  });
...
;
  ...
  assert_throws_dom("HierarchyRequestError", function() use($doc,$a,$comment) {global $document;;
...
;
  $a = $doc->createElement("a");
  assert_throws_dom("HierarchyRequestError", function() use ($doc,$a) {global $document;;
    $doc->insertBefore($a, $doc->doctype);
  });
...
;
  ...
  assert_throws_dom("HierarchyRequestError", function() {global $document;;
...
;
  $doctype = $document->implementation->createDocumentType("html", "", "");
  assert_throws_dom("HierarchyRequestError", function() use ($doc,$doctype) {global $document;;
    $doc->insertBefore($doctype, null);
  });
...
;
  $doc = DOM\HTMLDocument::createFromString("<!DOCTYPE html><html></html>");
  assert_throws_dom("HierarchyRequestError", function() use($df,$doc,$a) {global $document;;
...
;
  $doctype = $document->implementation->createDocumentType("html", "", "");
  assert_throws_dom("HierarchyRequestError", function() use ($df,$doctype,$a) {global $document;;
    $df->insertBefore($doctype, $a);
  });
  assert_throws_dom("HierarchyRequestError", function() use( $df,$doctype) {global $document;;
...
;
  $doc = DOM\HTMLDocument::createFromString("<!DOCTYPE html><html></html>");
  assert_throws_dom("HierarchyRequestError", function() use($doc,$el,$a) {global $document;;
    $el->insertBefore($doc, $a);
  });
  assert_throws_dom("HierarchyRequestError", function() use($doc,$el) {global $document;;
